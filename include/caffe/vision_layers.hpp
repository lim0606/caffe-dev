...
/**
 * @brief Averages the probs
 *
 * TODO(dox): thorough documentation for Forward, Backward, and proto params.
 */
template <typename Dtype>
class AVGProbsLayer : public Layer<Dtype> {
 public:
  explicit AVGProbsLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline LayerParameter_LayerType type() const {
    return LayerParameter_LayerType_AVG_PROBS;
  }
  virtual inline int ExactNumBottomBlobs() const { return 1; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
 ...
 protected:
  ...
  int multi_infer_size_; 
  int batch_size_;

  int num_; // batch_size_ * multi_infer_size_; 
  int channels_; 
  int height_; 
  int width_;  
  int K_; 
 ...
 */
template <typename Dtype>
class AVGProbsMultiSourcesLayer : public Layer<Dtype> {
 public:
  explicit AVGProbsMultiSourcesLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline LayerParameter_LayerType type() const {
    return LayerParameter_LayerType_AVG_PROBS_MULTI_SOURCES;
  }
  //virtual inline int ExactNumBottomBlobs() const { return 1; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
